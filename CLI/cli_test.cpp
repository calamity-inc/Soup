...
static void unit_crypto()
{
	...
	unit("ecc")
	{
		test("secp256k1", []
		{
			...
			assert(p.getX() == "0x779DD197A5DF977ED2CF6CB31D82D43328B790DC6B3B7D4437A427BD5847DFCD"_b);
			assert(p.getY() == "0xE94B724A555B6D017BB7607C3E3281DAF5B1699D6EF4124975C9237B917D426F"_b);
#else
			auto p = curve.add(curve.G, curve.G);
			assert(p.getX() == "0xC6047F9441ED7D6D3045406E95C07CD85C778E4B8CEF3CA7ABAC09B95C709EE5"_b);
			assert(p.getY() == "0x1AE168FEA63DC339A3C58419466CEAEEF7F632653266D0E1236431A950CFE52A"_b);
#endif
		});
		test("secp256r1", []
		{
		...
		test("secp384r1", []
		{
			...
			assert(p.getX() == "0xB7828FF3F814932B531D3CD58947A77655CA12EE533333EE12E921C39114B752BEFDB3E45C05D6C1F8222C5C6B234E8D"_b);
			assert(p.getY() == "0x1F4B1BBA3434C6BAA34250744B4E109E09A55D5F3075BEC33256C94A468792C2B5650D24F85482C988B7328E825F488D"_b);
#else
			auto p = curve.add(curve.G, curve.G);
			assert(p.getX() == "0x8D999057BA3D2D969260045C55B97F089025959A6F434D651D207D19FB96E9E4FE0E86EBE0E64F85B96A9C75295DF61"_b);
			assert(p.getY() == "0x8E80F1FA5B1B3CEDB7BFE8DFFD6DBA74B275D875BC6CC43E904E505F256AB4255FFD43E94D39E22D61501E700A940E80"_b);
#endif
		});
		...
		test("point compression on secp256r1", []
		{
			...
			assert(p.getX() == "0x4335E9B1328C5B5F3C7086EF78DE08519563703A572C8EF44974D11D793542D3"_b);
			assert(p.getY() == "0x31C89D7DE56498EA51609AB1ECB94FCCDF2DCF0ECA08E19DFDC3A2EF07A8D734"_b);
			...
			assert(p.getX() == "0x413029CB9A5A4A0B087A9B8A060116D0D32BB22D14AEBF7778215744811BB6CE"_b);

...
#define F25519_SIZE 32
	...
	void ec::curve25519_generatePrivate(uint8_t(&private_key)[X25519_KEY_SIZE])
	{
	...
	void ec::x25519(uint8_t(&shared_secret)[X25519_SHARED_SIZE], const uint8_t(&my_private_key)[X25519_KEY_SIZE], const uint8_t(&their_public_key)[X25519_KEY_SIZE])
	{

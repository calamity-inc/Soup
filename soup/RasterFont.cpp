...
NAMESPACE_SOUP
{
	...
	[[nodiscard]] static RasterFont generateSimple8()
	{
		...
		// Katakana - 2 pixels of space between characters
		{
			...
			f.glyphs.emplace(U'ヘ', Glyph(7, 8, {
				_,_,_,_,_,_,_,
				_,_,W,_,_,_,_,
				_,W,_,W,_,_,_,
				W,_,_,_,W,_,_,
			...
			f.glyphs.emplace(U'ミ', Glyph(8, 8, {
				_,_,_,_,_,_,_,_,
				W,W,W,W,W,W,W,_,
				_,_,_,_,_,_,_,_,
				_,_,_,_,_,_,_,_,
			...
			f.glyphs.emplace(U'ュ', Glyph(5, 8, {
				_,_,_,_,_,
				_,_,_,_,_,
				_,_,_,_,_,
				_,_,_,_,_,
			...
			f.glyphs.emplace(U'ョ', Glyph(4, 8, {
				_,_,_,_,
				_,_,_,_,
				_,_,_,_,
				W,W,W,_,
			...
			f.glyphs.emplace(U'ー', Glyph(7, 8, {
				_,_,_,_,_,_,_,
				_,_,_,_,_,_,_,
				_,_,_,_,_,_,_,
				W,W,W,W,W,W,_,

...
NAMESPACE_SOUP
{
	...
	[[nodiscard]] static RasterFont generateSimple5()
	{
		...
		f.glyphs.emplace(0x2B1A, Glyph(6, 5, {
			W,_,W,_,W,_,
			_,_,_,_,_,_,
			W,_,_,_,W,_,
			_,_,_,_,_,_,
	...
	[[nodiscard]] static RasterFont generateSimple8()
	{
		...
		f.glyphs.emplace(0x2B1A, Glyph(9, 8, {
			_,W,_,W,_,W,_,W,_,
			W,_,_,_,_,_,_,_,_,
			_,_,_,_,_,_,_,W,_,
			W,_,_,_,_,_,_,_,_,
		...
		// Katakana - 2 pixels of space between characters
		{
			f.glyphs.emplace(U'ア', Glyph(8, 8, {
				W,W,W,W,W,W,W,_,
				_,_,_,_,_,W,_,_,
				_,_,W,_,W,_,_,_,
				_,_,W,W,_,_,_,_,
			...
			f.glyphs.emplace(U'ァ', Glyph(6, 5, {
				W,W,W,W,W,_,
				_,_,_,_,W,_,
				_,W,W,W,_,_,
				_,W,_,_,_,_,
			...
			f.glyphs.emplace(U'イ', Glyph(7, 8, {
				_,_,_,_,_,W,_,
				_,_,_,_,W,_,_,
				_,_,W,W,_,_,_,
				_,W,_,W,_,_,_,
			...
			f.glyphs.emplace(U'ィ', Glyph(5, 5, {
				_,_,_,W,_,
				_,_,W,_,_,
				_,W,W,_,_,
				W,_,W,_,_,
			...
			f.glyphs.emplace(U'ウ', Glyph(8, 8, {
				_,_,_,W,_,_,_,_,
				W,W,W,W,W,W,W,_,
				W,_,_,_,_,_,W,_,
				_,_,_,_,_,_,W,_,
			...
			f.glyphs.emplace(U'ゥ', Glyph(4, 5, {
				_,W,_,_,
				W,W,W,_,
				W,_,W,_,
				_,_,W,_,
			...
			f.glyphs.emplace(U'エ', Glyph(8, 8, {
				W,W,W,W,W,W,W,_,
				_,_,_,W,_,_,_,_,
				_,_,_,W,_,_,_,_,
				_,_,_,W,_,_,_,_,
			...
			f.glyphs.emplace(U'ェ', Glyph(6, 5, {
				W,W,W,W,W,_,
				_,_,W,_,_,_,
				_,_,W,_,_,_,
				_,_,W,_,_,_,
			...
			f.glyphs.emplace(U'オ', Glyph(8, 8, {
				_,_,_,_,W,_,_,_,
				W,W,W,W,W,W,W,_,
				_,_,_,_,W,_,_,_,
				_,_,_,W,W,_,_,_,
			...
			f.glyphs.emplace(U'ォ', Glyph(6, 5, {
				_,_,_,W,_,_,
				W,W,W,W,W,_,
				_,_,W,W,_,_,
				_,W,_,W,_,_,
			...
			f.glyphs.emplace(U'ン', Glyph(8, 8, {
				W,W,W,_,_,_,_,_,
				_,_,_,_,_,_,_,_,
				_,_,_,_,_,_,W,_,
				_,_,_,_,_,_,W,_,
			...
			f.glyphs.emplace(U'カ', Glyph(8, 8, {
				_,_,W,_,_,_,_,_,
				W,W,W,W,W,W,W,_,
				_,_,W,_,_,_,W,_,
				_,_,W,_,_,_,W,_,
			...
			f.glyphs.emplace(U'ガ', Glyph(8, 8, {
				_,_,_,_,W,_,W,_,
				_,_,_,_,W,_,W,_,
				_,W,_,_,_,_,_,_,
				W,W,W,W,W,_,_,_,
			...
			f.glyphs.emplace(U'キ', Glyph(8, 8, {
				_,_,_,W,_,_,_,_,
				_,W,W,W,W,W,_,_,
				_,_,_,W,_,_,_,_,
				W,W,W,W,W,W,W,_,
			...
			f.glyphs.emplace(U'ギ', Glyph(8, 8, {
				_,_,_,_,W,_,W,_,
				_,_,_,_,W,_,W,_,
				_,W,_,_,_,_,_,_,
				W,W,W,_,_,_,_,_,
			...
			f.glyphs.emplace(U'ク', Glyph(8, 8, {
				_,W,_,_,_,_,_,_,
				_,W,W,W,W,W,W,_,
				_,W,_,_,_,_,W,_,
				W,_,_,_,_,_,W,_,
			...
			f.glyphs.emplace(U'グ', Glyph(8, 8, {
				_,_,_,_,W,_,W,_,
				_,_,_,_,W,_,W,_,
				_,W,_,_,_,_,_,_,
				_,W,W,W,W,_,_,_,
			...
			f.glyphs.emplace(U'ケ', Glyph(8, 8, {
				_,W,_,_,_,_,_,_,
				_,W,W,W,W,W,W,_,
				_,W,_,_,_,W,_,_,
				W,_,_,_,_,W,_,_,
			...
			f.glyphs.emplace(U'ゲ', Glyph(8, 8, {
				_,_,_,_,W,_,W,_,
				_,_,_,_,W,_,W,_,
				_,W,_,_,_,_,_,_,
				_,W,W,W,W,W,_,_,
			...
			f.glyphs.emplace(U'コ', Glyph(8, 8, {
				W,W,W,W,W,W,W,_,
				_,_,_,_,_,_,W,_,
				_,_,_,_,_,_,W,_,
				_,_,_,_,_,_,W,_,
			...
			f.glyphs.emplace(U'ゴ', Glyph(8, 8, {
				_,_,_,_,W,_,W,_,
				_,_,_,_,W,_,W,_,
				_,_,_,_,_,_,_,_,
				W,W,W,W,_,_,_,_,
			...
			f.glyphs.emplace(U'サ', Glyph(7, 8, {
				_,W,_,_,W,_,_,
				_,W,_,_,W,_,_,
				W,W,W,W,W,W,_,
				_,W,_,_,W,_,_,
			...
			f.glyphs.emplace(U'ザ', Glyph(8, 8, {
				_,_,_,_,W,_,W,_,
				_,_,_,_,W,_,W,_,
				_,W,_,W,_,_,_,_,
				W,W,W,W,W,_,_,_,
			...
			f.glyphs.emplace(U'シ', Glyph(8, 8, {
				W,W,W,_,_,_,_,_,
				_,_,_,_,_,_,_,_,
				W,W,W,_,_,_,W,_,
				_,_,_,_,_,_,W,_,
			...
			f.glyphs.emplace(U'ジ', Glyph(8, 8, {
				_,_,_,_,W,_,W,_,
				_,_,_,_,W,_,W,_,
				W,W,W,_,_,_,_,_,
				_,_,_,_,_,W,_,_,
			...
			f.glyphs.emplace(U'ス', Glyph(8, 8, {
				W,W,W,W,W,W,W,_,
				_,_,_,_,_,_,W,_,
				_,_,_,_,_,W,_,_,
				_,_,_,_,W,_,_,_,
			...
			f.glyphs.emplace(U'ズ', Glyph(8, 8, {
				_,_,_,_,W,_,W,_,
				_,_,_,_,W,_,W,_,
				_,_,_,_,_,_,_,_,
				W,W,W,W,W,_,_,_,
			...
			f.glyphs.emplace(U'セ', Glyph(8, 8, {
				_,W,_,_,_,_,_,_,
				W,W,W,W,W,W,W,_,
				_,W,_,_,_,_,W,_,
				_,W,_,_,_,W,_,_,
			...
			f.glyphs.emplace(U'ゼ', Glyph(8, 8, {
				_,_,_,_,W,_,W,_,
				_,_,_,_,W,_,W,_,
				_,W,_,_,_,_,_,_,
				W,W,W,W,W,_,_,_,
			...
			f.glyphs.emplace(U'ソ', Glyph(8, 8, {
				W,_,_,_,_,_,W,_,
				W,_,_,_,_,_,W,_,
				W,_,_,_,_,_,W,_,
				_,_,_,_,_,_,W,_,
			...
			f.glyphs.emplace(U'ゾ', Glyph(8, 8, {
				_,_,_,_,W,_,W,_,
				_,_,_,_,W,_,W,_,
				W,_,_,_,_,_,_,_,
				W,_,_,_,_,W,_,_,
			...
			f.glyphs.emplace(U'タ', Glyph(8, 8, {
				_,W,_,_,_,_,_,_,
				_,W,W,W,W,W,W,_,
				_,W,_,_,_,_,W,_,
				W,_,_,W,_,_,W,_,
			...
			f.glyphs.emplace(U'ダ', Glyph(8, 8, {
				_,_,_,_,W,_,W,_,
				_,_,_,_,W,_,W,_,
				_,W,_,_,_,_,_,_,
				_,W,W,W,_,_,_,_,
			...
			f.glyphs.emplace(U'チ', Glyph(8, 8, {
				W,W,W,W,W,W,W,_,
				_,_,_,W,_,_,_,_,
				W,W,W,W,W,W,W,_,
				_,_,_,W,_,_,_,_,
			...
			f.glyphs.emplace(U'ヂ', Glyph(9, 8, {
				_,_,_,_,_,W,_,W,_,
				_,_,_,_,_,W,_,W,_,
				W,W,W,W,W,_,_,_,_,
				_,_,W,_,_,_,_,_,_,
			...
			f.glyphs.emplace(U'ツ', Glyph(8, 8, {
				W,_,W,_,_,_,W,_,
				W,_,W,_,_,_,W,_,
				W,_,W,_,_,_,W,_,
				_,_,_,_,_,_,W,_,
			...
			f.glyphs.emplace(U'ヅ', Glyph(8, 8, {
				_,_,_,_,W,_,W,_,
				_,_,_,_,W,_,W,_,
				W,_,W,_,_,_,_,_,
				W,_,W,_,_,W,_,_,
			...
			f.glyphs.emplace(U'ッ', Glyph(6, 5, {
				W,_,W,_,_,_,
				W,_,W,_,W,_,
				_,_,_,_,W,_,
				_,_,_,_,W,_,
			...
			f.glyphs.emplace(U'テ', Glyph(8, 8, {
				_,W,W,W,W,W,_,_,
				_,_,_,_,_,_,_,_,
				W,W,W,W,W,W,W,_,
				_,_,_,W,_,_,_,_,
			...
			f.glyphs.emplace(U'デ', Glyph(9, 8, {
				_,_,_,_,_,W,_,W,_,
				_,_,_,_,_,W,_,W,_,
				W,W,W,W,W,_,_,_,_,
				_,_,W,_,_,_,_,_,_,
			...
			f.glyphs.emplace(U'ト', Glyph(5, 8, {
				W,_,_,_,_,
				W,_,_,_,_,
				W,W,_,_,_,
				W,_,W,_,_,
			...
			f.glyphs.emplace(U'ド', Glyph(6, 8, {
				W,_,_,W,_,W,
				W,_,_,W,_,W,
				W,W,_,_,_,_,
				W,_,W,_,_,_,
			...
			f.glyphs.emplace(U'ナ', Glyph(8, 8, {
				_,_,_,W,_,_,_,_,
				_,_,_,W,_,_,_,_,
				W,W,W,W,W,W,W,_,
				_,_,_,W,_,_,_,_,
			...
			f.glyphs.emplace(U'ニ', Glyph(8, 8, {
				_,_,_,_,_,_,_,_,
				_,_,_,_,_,_,_,_,
				_,W,W,W,W,W,_,_,
				_,_,_,_,_,_,_,_,
			...
			f.glyphs.emplace(U'ヌ', Glyph(8, 8, {
				W,W,W,W,W,W,W,_,
				_,_,_,_,_,_,W,_,
				_,_,_,_,_,_,W,_,
				_,_,W,_,_,_,W,_,
			...
			f.glyphs.emplace(U'ネ', Glyph(8, 8, {
				_,_,_,W,_,_,_,_,
				W,W,W,W,W,W,W,_,
				_,_,_,_,_,W,_,_,
				_,_,_,_,W,_,_,_,
			...
			f.glyphs.emplace(U'ノ', Glyph(7, 8, {
				_,_,_,_,_,W,_,
				_,_,_,_,_,W,_,
				_,_,_,_,W,_,_,
				_,_,_,_,W,_,_,
			...
			f.glyphs.emplace(U'ハ', Glyph(8, 8, {
				_,_,W,_,W,_,_,_,
				_,_,W,_,W,_,_,_,
				_,_,W,_,W,_,_,_,
				_,_,W,_,W,_,_,_,
			...
			f.glyphs.emplace(U'バ', Glyph(8, 8, {
				_,_,_,_,W,_,W,_,
				_,_,_,_,W,_,W,_,
				_,_,_,_,_,_,_,_,
				_,W,_,W,_,_,_,_,
			...
			f.glyphs.emplace(U'パ', Glyph(8, 8, {
				_,_,_,_,_,W,_,_,
				_,_,_,_,W,_,W,_,
				_,_,_,_,_,W,_,_,
				_,W,_,W,_,_,_,_,
			...
			f.glyphs.emplace(U'ヒ', Glyph(7, 8, {
				W,_,_,_,_,_,_,
				W,_,_,_,_,_,_,
				W,_,_,_,_,W,_,
				W,W,W,W,W,_,_,
			...
			f.glyphs.emplace(U'ビ', Glyph(8, 8, {
				_,_,_,_,W,_,W,_,
				_,_,_,_,W,_,W,_,
				W,_,_,_,_,_,_,_,
				W,_,_,_,W,_,_,_,
			...
			f.glyphs.emplace(U'ピ', Glyph(8, 8, {
				_,_,_,_,_,W,_,_,
				_,_,_,_,W,_,W,_,
				W,_,_,_,_,W,_,_,
				W,_,_,W,_,_,_,_,
			...
			f.glyphs.emplace(U'フ', Glyph(8, 8, {
				W,W,W,W,W,W,W,_,
				_,_,_,_,_,_,W,_,
				_,_,_,_,_,_,W,_,
				_,_,_,_,_,_,W,_,
			...
			f.glyphs.emplace(U'ブ', Glyph(8, 8, {
				_,_,_,_,W,_,W,_,
				_,_,_,_,W,_,W,_,
				_,_,_,_,_,_,_,_,
				W,W,W,W,_,_,_,_,
			...
			f.glyphs.emplace(U'プ', Glyph(8, 8, {
				_,_,_,_,_,W,_,_,
				_,_,_,_,W,_,W,_,
				_,_,_,_,_,W,_,_,
				W,W,W,W,_,_,_,_,
			...
			f.glyphs.emplace(U'ヘ', Glyph(7, 4, {
				_,_,W,_,_,_,_,
				_,W,_,W,_,_,_,
				W,_,_,_,W,_,_,
				_,_,_,_,_,W,_,
			}, 2));
			f.glyphs.emplace(U'ベ', Glyph(8, 6, {
				_,_,_,_,W,_,W,_,
				_,_,_,_,W,_,W,_,
				_,_,W,_,_,_,_,_,
				_,W,_,W,_,_,_,_,
			...
			f.glyphs.emplace(U'ペ', Glyph(8, 6, {
				_,_,_,_,_,W,_,_,
				_,_,_,_,W,_,W,_,
				_,_,W,_,_,W,_,_,
				_,W,_,W,_,_,_,_,
			...
			f.glyphs.emplace(U'ホ', Glyph(8, 8, {
				_,_,_,W,_,_,_,_,
				_,_,_,W,_,_,_,_,
				W,W,W,W,W,W,W,_,
				_,_,_,W,_,_,_,_,
			...
			f.glyphs.emplace(U'ボ', Glyph(8, 8, {
				_,_,_,_,W,_,W,_,
				_,_,_,_,W,_,W,_,
				_,_,W,_,_,_,_,_,
				_,_,W,_,_,_,_,_,
			...
			f.glyphs.emplace(U'ポ', Glyph(8, 8, {
				_,_,_,_,_,_,W,_,
				_,_,_,_,_,W,_,W,
				_,_,W,_,_,_,W,_,
				_,_,W,_,_,_,_,_,
			...
			f.glyphs.emplace(U'マ', Glyph(8, 8, {
				W,W,W,W,W,W,W,_,
				_,_,_,_,_,_,W,_,
				_,_,_,_,_,W,_,_,
				_,_,_,_,W,_,_,_,
			...
			f.glyphs.emplace(U'ミ', Glyph(8, 7, {
				W,W,W,W,W,W,W,_,
				_,_,_,_,_,_,_,_,
				_,_,_,_,_,_,_,_,
				W,W,W,W,W,W,W,_,
			...
			f.glyphs.emplace(U'ム', Glyph(8, 8, {
				_,_,_,W,_,_,_,_,
				_,_,_,W,_,_,_,_,
				_,_,W,_,_,_,_,_,
				_,_,W,_,_,_,_,_,
			...
			f.glyphs.emplace(U'メ', Glyph(8, 8, {
				_,_,_,_,_,_,W,_,
				_,_,_,_,_,_,W,_,
				_,_,W,_,_,_,W,_,
				_,_,_,W,_,W,_,_,
			...
			f.glyphs.emplace(U'モ', Glyph(8, 8, {
				_,W,W,W,W,W,_,_,
				_,_,_,W,_,_,_,_,
				W,W,W,W,W,W,W,_,
				_,_,_,W,_,_,_,_,
			...
			f.glyphs.emplace(U'ヤ', Glyph(8, 8, {
				_,W,_,_,_,_,_,_,
				W,W,W,W,W,W,W,_,
				_,W,_,_,_,_,W,_,
				_,W,_,_,_,W,_,_,
			...
			f.glyphs.emplace(U'ャ', Glyph(5, 8, {
				_,_,_,_,_,
				_,_,_,_,_,
				_,_,_,_,_,
				W,_,_,_,_,
			...
			f.glyphs.emplace(U'ユ', Glyph(8, 8, {
				W,W,W,W,W,W,_,_,
				_,_,_,_,_,W,_,_,
				_,_,_,_,_,W,_,_,
				_,_,_,_,_,W,_,_,
			...
			f.glyphs.emplace(U'ュ', Glyph(5, 4, {
				W,W,W,_,_,
				_,_,W,_,_,
				_,_,W,_,_,
				W,W,W,W,_,
			}, 4));
			f.glyphs.emplace(U'ヨ', Glyph(8, 8, {
				_,_,_,_,_,_,_,_,
				W,W,W,W,W,W,W,_,
				_,_,_,_,_,_,W,_,
				_,_,_,_,_,_,W,_,
			...
			f.glyphs.emplace(U'ョ', Glyph(4, 5, {
				W,W,W,_,
				_,_,W,_,
				W,W,W,_,
				_,_,W,_,
			...
			f.glyphs.emplace(U'ラ', Glyph(8, 8, {
				_,W,W,W,W,W,_,_,
				_,_,_,_,_,_,_,_,
				W,W,W,W,W,W,W,_,
				_,_,_,_,_,_,W,_,
			...
			f.glyphs.emplace(U'リ', Glyph(5, 8, {
				W,_,_,W,_,
				W,_,_,W,_,
				W,_,_,W,_,
				W,_,_,W,_,
			...
			f.glyphs.emplace(U'ル', Glyph(8, 8, {
				_,_,W,_,W,_,_,_,
				_,_,W,_,W,_,_,_,
				_,_,W,_,W,_,_,_,
				_,_,W,_,W,_,_,_,
			...
			f.glyphs.emplace(U'レ', Glyph(8, 8, {
				W,_,_,_,_,_,_,_,
				W,_,_,_,_,_,_,_,
				W,_,_,_,_,_,_,_,
				W,_,_,_,_,_,W,_,
			...
			f.glyphs.emplace(U'ロ', Glyph(8, 8, {
				W,W,W,W,W,W,W,_,
				W,_,_,_,_,_,W,_,
				W,_,_,_,_,_,W,_,
				W,_,_,_,_,_,W,_,
			...
			f.glyphs.emplace(U'ワ', Glyph(8, 8, {
				W,W,W,W,W,W,W,_,
				W,_,_,_,_,_,W,_,
				W,_,_,_,_,_,W,_,
				_,_,_,_,_,_,W,_,
			...
			f.glyphs.emplace(U'ヲ', Glyph(8, 8, {
				W,W,W,W,W,W,W,_,
				_,_,_,_,_,_,W,_,
				W,W,W,W,W,W,W,_,
				_,_,_,_,_,_,W,_,
			...
			f.glyphs.emplace(U'ー', Glyph(7, 1, {
				W,W,W,W,W,W,_,
			}, 3));
			f.glyphs.emplace(U'・', Glyph(6, 2, {
				_,_,W,W,_,_,
				_,_,W,W,_,_,
			}, 3));
		}
	...
	const Glyph& RasterFont::get(uint32_t c) const
	{
		...
		if (e == glyphs.end())
		{
			e = glyphs.find(0x2B1A);
			SOUP_IF_UNLIKELY (e == glyphs.end())
			{
				e = glyphs.find('?');
				if (e == glyphs.end())
				{
	...
	{
#if SOUP_CPP20
		SOUP_IF_LIKELY (glyphs.contains(0x2B1A))
#else
		SOUP_IF_LIKELY (glyphs.find(0x2B1A) != glyphs.end())
#endif
		{
			return 0x2B1A;
		}

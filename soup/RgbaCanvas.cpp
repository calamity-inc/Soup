...
NAMESPACE_SOUP
{
	...
	bool RgbaCanvas::toBmp(Writer& w) const
	{
		...
		SOUP_IF_UNLIKELY (!(s = 0x4D42, w.u16_le(s))
			|| !(i = static_cast<uint32_t>(108 + (4 * pixels.size())), w.u32_le(i))
			|| !w.skip(4)
			|| !(i = (14 + 108), w.u32_le(i))
			|| !(i = 108, w.u32_le(i))
			|| !(i = width, w.u32_le(i))
			...
			|| !(s = 32, w.u16_le(s))
			|| !(i = 3, w.u32_le(i))
			|| !(i = static_cast<uint32_t>(4 * pixels.size()), w.u32_le(i))
			|| !w.skip(4 + 4 + 4 + 4)
			|| !(i = 0x00FF0000, w.u32_le(i))
			|| !(i = 0x0000FF00, w.u32_le(i))
			|| !(i = 0x000000FF, w.u32_le(i))
			|| !(i = 0xFF000000, w.u32_le(i))
			|| !(b = 0x20, w.u8(b))
			|| !(b = 0x6E, w.u8(b))
			|| !(b = 0x69, w.u8(b))
			|| !(b = 0x57, w.u8(b))

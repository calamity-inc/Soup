...
namespace soup
{
	...
	public:
		...
		*/
		static qr_code encodeText(const char* text, ecc ecl = ecc::LOW);
		...
		*/
		static qr_code encodeBinary(const std::vector<std::uint8_t>& data, ecc ecl = ecc::LOW);
		...
		*/
		static qr_code encodeSegments(const std::vector<segment>& segs, ecc ecl = ecc::LOW);
	...
	public:
		...
		*/
		[[nodiscard]] int8_t getMask() const;
	...
	private:
		...
		bool getModuleInbounds(int x, int y) const;
	...
	public:
		...
		*/
		class segment_mode
		{
			...
			public: static const segment_mode NUMERIC;
			public: static const segment_mode ALPHANUMERIC;
			public: static const segment_mode BYTE;
			public: static const segment_mode KANJI;
			public: static const segment_mode ECI;
			...
			private: segment_mode(int mode, int cc0, int cc1, int cc2);
		...
		*/
		...
		public:
			...
			*/
			public: static segment makeBytes(const std::vector<std::uint8_t>& data);

			/*
			* Returns a segment representing the given string of decimal digits encoded in numeric mode.
			*/
			public: static segment makeNumeric(const char* digits);
			...
			*/
			public: static segment makeAlphanumeric(const char* text);

			/*
			* Returns a list of zero or more segments to represent the given text string. The result
			* may use various segment modes and switch modes to optimize the length of the bit stream.
			*/
			public: static std::vector<segment> makeSegments(const char* text);

			/*
			* Returns a segment representing an Extended Channel Interpretation
			* (ECI) designator with the given assignment value.
			*/
			public: static segment makeEci(long assignVal);
			...
			*/
			...
			private: const segment_mode* mode;

			/* The length of this segment's unencoded data. Measured in characters for
			* numeric/alphanumeric/kanji mode, bytes for byte mode, and 0 for ECI mode.
			* Always zero or positive. Not the same as the data's bit length.
			* Accessed through getNumChars(). */
			private: unsigned int numChars;
			...
			*/
			public: segment(const segment_mode& md, unsigned int numCh, const std::vector<bool>& dt);
			...
			*/
			public: segment(const segment_mode& md, unsigned int numCh, std::vector<bool>&& dt);
			...
			*/
			public: const segment_mode& getMode() const;
			...
			*/
			...
			public: static int getTotalBits(const std::vector<segment>& segs, int version);

...
namespace soup
{
	...
	public:
		...
		bool str_utf8_nt(std::string& str); // A UTF-8 string encoded using 6-23 bits per codepoint.
		bool str_utf32_nt(std::u32string& str); // A UTF-32 string encoded using 6-23 bits per codepoint.
	};
}

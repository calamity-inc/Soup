...
namespace soup
{
	class io_virtual_base
	{
	protected:
		const bool native_endianness;

		io_virtual_base(bool little_endian)
			: native_endianness(SOUP_LITTLE_ENDIAN == little_endian)
		{
		}

	public:
		virtual ~io_virtual_base() = default;
	...
	class io_base : public io_virtual_base
	{
	protected:
		using io_virtual_base::io_virtual_base;
